...
painter = trtl.Turtle()
# configure turtle, goto start position
painter.penup()
painter.goto(-200,221)
painter.shape("square")
painter.color("blue")

# write the binary out as blank and colored areas in the image
